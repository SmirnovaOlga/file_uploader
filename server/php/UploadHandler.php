...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/files/animals/cat/',
            ...
            'image_versions' => array(
                ...
                */
                'thumbnail' => array(
                    ...
                    //'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/files/animals/cat/thumb/',
